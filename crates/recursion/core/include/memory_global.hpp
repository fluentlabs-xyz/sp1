...
namespace rwasm_machine_sys::memory_global {
template <class F, class EF7>
__SP1_HOSTDEV__ void event_to_row(const MemoryInitializeFinalizeEvent* event,
                                  const bool is_receive,
                                  MemoryInitCols<F>* cols) {
  ...
  cols->addr_bits.and_most_sig_byte_decomp_3_to_5 =
      cols->addr_bits.bits[27] * cols->addr_bits.bits[28];
  cols->addr_bits.and_most_sig_byte_decomp_3_to_6 =
      cols->addr_bits.and_most_sig_byte_decomp_3_to_5 *
      cols->addr_bits.bits[29];
  cols->addr_bits.and_most_sig_byte_decomp_3_to_7 =
      cols->addr_bits.and_most_sig_byte_decomp_3_to_6 *
      cols->addr_bits.bits[30];
