...
pub fn rwasm_ins_to_riscv_ins(instruction: Instruction) -> Opcode {
    match instruction {
        Instruction::I32Add => Opcode::ADD,
        Instruction::I32Sub => Opcode::SUB,
        Instruction::I32Xor => Opcode::XOR,
        Instruction::I32Or => Opcode::OR,
        Instruction::I32And => Opcode::AND,
        Instruction::I32Shl => Opcode::SLL,
        Instruction::I32ShrS => Opcode::SRA,
        Instruction::I32ShrU => Opcode::SRL,

        Instruction::I32GeU
        | Instruction::I32GtU
        | Instruction::I32LeU
        | Instruction::I32LtU
        | Instruction::I32Eqz => Opcode::SLTU,
        Instruction::I32GeS | Instruction::I32GtS | Instruction::I32LeS | Instruction::I32LeS => {
            Opcode::SLT
        }

        Instruction::I32Mul => Opcode::MUL,
        Instruction::I32DivS => Opcode::DIV,
        Instruction::I32DivU => Opcode::DIVU,
        Instruction::I32RemS => Opcode::REM,
        Instruction::I32RemU => Opcode::REMU,
