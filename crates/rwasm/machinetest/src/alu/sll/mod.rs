...
mod tests {
    ...
    use rwasm_machine::alu::{LtChip, MulChip, ShiftLeft, ShiftLeftCols};
    ...
    fn generate_trace() {
        ...
        shard.shift_left_events = vec![AluEvent::new(0, Instruction::I32Shl, 16, 8, 1, rwasm_ins_to_code(Instruction::I32Shl))];
    ...
    fn prove_babybear() {
        ...
        let shift_instructions: Vec<(Instruction, u32, u32, u32)> = vec![
            (Instruction::I32Shl, 0x00000002, 0x00000001, 1),
            (Instruction::I32Shl, 0x00000080, 0x00000001, 7),
            (Instruction::I32Shl, 0x00004000, 0x00000001, 14),
            (Instruction::I32Shl, 0x80000000, 0x00000001, 31),
            (Instruction::I32Shl, 0xffffffff, 0xffffffff, 0),
            (Instruction::I32Shl, 0xfffffffe, 0xffffffff, 1),
            (Instruction::I32Shl, 0xffffff80, 0xffffffff, 7),
            (Instruction::I32Shl, 0xffffc000, 0xffffffff, 14),
            (Instruction::I32Shl, 0x80000000, 0xffffffff, 31),
            (Instruction::I32Shl, 0x21212121, 0x21212121, 0),
            (Instruction::I32Shl, 0x42424242, 0x21212121, 1),
            (Instruction::I32Shl, 0x90909080, 0x21212121, 7),
            (Instruction::I32Shl, 0x48484000, 0x21212121, 14),
            (Instruction::I32Shl, 0x80000000, 0x21212121, 31),
            (Instruction::I32Shl, 0x21212121, 0x21212121, 0xffffffe0),
            (Instruction::I32Shl, 0x42424242, 0x21212121, 0xffffffe1),
            (Instruction::I32Shl, 0x90909080, 0x21212121, 0xffffffe7),
            (Instruction::I32Shl, 0x48484000, 0x21212121, 0xffffffee),
            (Instruction::I32Shl, 0x00000000, 0x21212120, 0xffffffff),
        ];
        ...
        for _ in 0..(1000 - shift_instructions.len()) {
            //shift_events.push(AluEvent::new(0, 0, Instruction::I32Shl, 14, 8, 6));
        }
    ...
    fn test_malicious_sll() {
        ...
        for _ in 0..NUM_TESTS {
            ...
            let instructions = vec![
                Instruction::new(Instruction::I32Shl, 5, op_b, op_c, true, true),
